...
{
    public partial class FrmSex : Form
    {
        public FrmSex()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Open();
                string selectsql = "update ManagerInfo set Sex ='" + textBox2.Text + "'where Sex='" + textBox1.Text + "'";
        ...
        private void FrmSex_Load(object sender, EventArgs e)
        {
